...
class Filler
{
    ...
    public function fill(string $file_path, array $data, bool $flatten = false, bool $hasDOSPage = false, bool $removeButtons = false, ?int $buttonPadding = null, bool $removeDOSPage = false): string
    {
